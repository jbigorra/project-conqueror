...
const FIELD_MAP: Record<string, Record<string, string>> = {
  ...
  "main-dev":             { entity: "entity", mainDev: "main-dev", added: "added", totalAdded: "total-added", ownership: "ownership" },
  "refactoring-main-dev": { entity: "entity", mainDev: "main-dev", removed: "removed", totalRemoved: "total-removed", ownership: "ownership" },
  "entity-effort":        { entity: "entity", author: "author", authorRevs: "author-revs", totalRevs: "total-revs" },
  "main-dev-by-revs":     { entity: "entity", mainDev: "main-dev", added: "added", totalAdded: "total-added", ownership: "ownership" },
