export const hotspotsEnclosureFixture = [
  ...
  {
    entity: "src/api/middleware/rate-limit.ts",
    nRevs: 12,
  ...
  {
    entity: "src/features/auth/register.ts",
    nRevs: 34,
  ...
  {
    entity: "src/features/dashboard/widgets.ts",
    nRevs: 28,
    cyclomaticComplexity: 9,
    linesOfCode: 250,
  },
  {
    entity: "src/features/reports/generator.ts",
    nRevs: 31,
    cyclomaticComplexity: 28,
    linesOfCode: 420,
  },
  {
    entity: "src/features/reports/export.ts",
    nRevs: 19,
  ...
  {
    entity: "src/shared/database/migrations.ts",
    nRevs: 42,
  ...
  {
    entity: "src/shared/utils/validation.ts",
    nRevs: 25,
